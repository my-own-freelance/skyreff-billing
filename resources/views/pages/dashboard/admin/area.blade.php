            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-header-left">
                        <h5 class="text-uppercase title">List Area</h5>
                    </div>
                ...
                <div class="card-block">
                    <div class="table-responsive mt-3">
                        <table class="table table-striped table-bordered nowrap dataTable" id="areaDataTable">
                            <thead>
                                <tr>
                                    <th class="all">#</th>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="code" type="text" name="code"
                                placeholder="opsional kode area" />
                        </div>
                        <div class="form-group">
...
@push('scripts')
    ...
    <script>
        ...
        function getData(id) {
            $.ajax({
                url: "{{ route('area.detail', ['id' => ':id']) }}".replace(':id', id),
                method: "GET",
                dataType: "json",
                success: function(res) {
                    $("#formEditable").attr("data-action", "update").fadeIn(200, function() {
                        ...
                        $("#meta").val(d.meta ? JSON.stringify(d.meta) : "");
                    })
                },
                error: function(err) {
        ...
        function saveData(data, action) {
            $.ajax({
                url: action == "update" ? "{{ route('area.update') }}" : "{{ route('area.create') }}",
                contentType: false,
                processData: false,
                method: "POST",
                data: data,
